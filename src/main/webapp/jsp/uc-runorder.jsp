                ...
                <div class="uc-panel-bd">
                    <div class="uc-sort">
                        <div class="uc-tabs">
                            ...
                            <a class="item active" href="<%=basePath%>jsp/uc-runorder.jsp">已发货</a>
                            <a class="item" href="<%=basePath%>jsp/uc-wait-receive.jsp">待收货</a>
                            <a class="item" href="<%=basePath%>jsp/uc-doneorder.jsp">已收货</a>
                        </div>
                        <div class="uc-search">
                            <form action="">
                            ...
                            <tr class="order-goods">
                                ...
                                <td>
                                    <div class="goods-info">
                                        <div><img src="${pageContext.request.contextPath }/${eachdetail.good.goodpic}"></div>
                                        <div><c:out value="${fn:substringBefore(eachdetail.good.goodname,fn:substringAfter(eachdetail.good.goodname,']'))}">
                                        </c:out></div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <span class="text-theme fwb">${runorder.total}</span>
                                </td>
                                <td>已付款</td>
                                <td>等待发货</td>
                            </tr>
