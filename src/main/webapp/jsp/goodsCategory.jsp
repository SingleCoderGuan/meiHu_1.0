...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <table class="table">
            ...
            <c:if test="${not empty pageInfoCategory}">
        ...
        <aside class="paging">
            <c:if test="${!pageInfoCategory.isFirstPage}">
                ...
                <a href="javascript:getPage(${pageInfoCategory.firstPage})">首页</a>
            </c:if>

            <c:if test="${!pageInfoCategory.isFirstPage}">
                <a href="javascript:getPage(${pageInfoCategory.prePage})">上一页</a>
            </c:if>
            <a> 共 ${pageInfoCategory.total}条
                当前第<span>${pageInfoCategory.pageNum}</span>页</a>
            <c:if test="${!pageInfoCategory.isLastPage}">
                <a href="javascript:getPage(${pageInfoCategory.nextPage})">下一页</a>
            </c:if>
            <c:if test="${!pageInfoCategory.isLastPage}">
                <a href="javascript:getPage(${pageInfoCategory.lastPage})">末页</a>
            </c:if>
    ...
    &lt;%&ndash;<c:if test="${empty pageInfo}">
        <c:forEach items="${pageInfoCategory.list}" var="allp">
