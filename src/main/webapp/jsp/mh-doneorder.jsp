                ...
                <table class="uc-table">
                    ...
                    <c:forEach items="${doneOrderList}" var="doneorder">
                        ...
                        <c:forEach items="${doneorder.items}" var="eachdetail">
                            ...
                            <td><c:if test="${eachdetail.item_state!=3}"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" style="position: relative;"
                                                                                 onclick="comment(${eachdetail.good.goodid},${user.uid},${doneorder.orderid})">评论</button></c:if>
                                <c:if test="${eachdetail.item_state==3}">
                                    <span style="position: relative;"><a href="#">已评论</a></span>
                                </c:if></td>
                            </tr>
                            <tr>
                                <td></td>
