                ...
                function tianjiaAddr() {
                    ...
                    $.ajax({
                        ...
                        success: function (address1) {
                            ...
                            $("#parent").append("  <div class='col col-4'><div class='item'><ul><li>" + address + "</li><li>" + addressdetail + "</li><li>" + receivename + "</li><li>" + receivetel + "</li></ul></div></div>");
//                            $("body").load("http://localhost:8080/meiHu_1.0/goods/order.action?method=save");
//                        $("#testhh").append(" <div class='info'><ul><li>"+address+"</li><li>"+addressdetail+"</li><li>"+receivename+"</li><li>"+receivetel+"</li></ul></div>");
                            <%--<br><li><div class='fl'> <a class='del' onclick='deleteAddress(${address.addressid})'>删除</a></div> <div class='fr'><a class='setdft' href='javascript:void(0);'>设为默认</a></div></li>--%>
            ...
            <div class="layui-form">
                ...
                <table class="layui-table">
                    <tr>
                        ...
                        <th colspan="1">未付款</th>
                        <th colspan="2">时间：<fmt:formatDate value="${order.ordertime}"
    ...
    <div class="pay">
        ...
        <form id="payform" action="<%=basePath %>goods/pay.action" method="post">
            ...
            <c:set var="youhui" value="$('#youhuiquan').val()" scope="request"/>
            ...
            <script>
                 function queding() {
                    ...
                    $('#yingfu').html("${order.total}"*a+"(${order.total}*"+a+")");
                }
            </script>
