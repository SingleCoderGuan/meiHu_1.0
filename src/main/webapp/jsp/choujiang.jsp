...
<c:if test="${empty sessionScope.user}">
    <a href="<%=basePath%>jsp/loginregister.jsp" class="btn btn-default btn-lg btn-block">当前未登录，点击可登录</a>
</c:if>
<c:if test="${not empty sessionScope.user}">
    <button type="button" class="btn btn-default btn-lg btn-block">您目前有<em>${point}</em>积分</button>
</c:if>
<div class="g-content">
        ...
        <div class="g-left">
            ...
            <div class="g-lottery-box">
                <div class="g-lottery-img">
                    <a class="playbtn" href="javascript:;" title="开始抽奖" onclick="choujiang()"></a>
                </div>
            </div>
        </div>
    </div>
...
<script>
        ...
        var clickfunc = function() {
            ...
            switch(data) {
                case 1:
                    rotateFunc(1, 6, '谢谢参与~再来一次吧~!');
                    break;
                case 2:
                    rotateFunc(2, 36, '恭喜您获得九折优惠券');
                    break;
                case 3:
                    rotateFunc(3, 72, '谢谢参与~再来一次吧~!');
                    break;
                case 4:
                    rotateFunc(4, 108, '恭喜您获得九折优惠券!');
                    break;
                case 5:
                    rotateFunc(5, 144, '恭喜您获得五折优惠券！');
                    break;
                case 6:
                    rotateFunc(6, 180, '谢谢参与~再来一次吧~!');
                    break;
                case 7:
                    rotateFunc(7, 216, '恭喜您获得八折优惠券！');
                    break;
                case 8:
                    rotateFunc(8, 252, '谢谢参与~再来一次吧~!');
                    break;
                case 9:
                    rotateFunc(9, 292, '恭喜您获得五折优惠券！');
                    break;
                case 10:
                    rotateFunc(10, 324, '恭喜您获得九折优惠券!');
                    break;
            }
        }
